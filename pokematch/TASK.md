...
[ ] Inicializar el proyecto en Spring Initializr (Java 17+, Spring Boot 3, Web, JPA, PostgreSQL, Lombok, Validation).

[ ] Configurar el archivo application.yml con las propiedades de la base de datos y puertos.

[ ] Crear el archivo docker-compose.yml base para levantar PostgreSQL.

[ ] Capa de Integración (PokeAPI)

[ ] Crear una clase de configuración para instanciar el WebClient.
...
[ ] Asegurarse de que el archivo docker-compose.yml levanta la base de datos de manera aislada y limpia.

[ ] Probar la aplicación desde cero clonando el repositorio en una carpeta limpia.

[ ] Documentación Técnica (README)

[ ] Escribir la descripción del proyecto en inglés.

[ ] Incluir la lista de tecnologías y versiones utilizadas (Java 17, Spring Boot 3, Angular).

[ ] Explicar la arquitectura (uso del patrón Strategy, uso de caché, diseño de excepciones).

[ ] Añadir la sección "How to run" con los comandos exactos de Docker y Maven/NPM.